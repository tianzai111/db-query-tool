...
class ExportRequest(BaseModel):
    ...
    The request carries the SQL to execute (or re-execute) plus the desired
    output format. The backend executes the SQL, then streams the result back
    as a downloadable file, which makes it easy to automate "run query +
    export" in a single step from an AI agent.
    """
